...
Original file is located at
    https://colab.research.google.com/drive/1ebArn0pXXTQIyipQXo2TfEdJKVPLCaeK
"""
...
df = pd.read_csv('https://raw.githubusercontent.com/Zenuu19/hackathon/main/suspicious_activity.csv')
df
...
X = df.drop('SuspiciousFlag', axis =  1)
X
...
plt.ylabel('Predict SuspiciousFlag')
plt.xlabel('Experimental SuspiciousFlag')